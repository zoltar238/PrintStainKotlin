...
class PersonService() {
    ...
    suspend fun loginUser(loginDto: LoginDto): ResponseApi<String> {
        ...
        return try {
            ...
            AppLogger.d("[DBG-$processCode: $processName] -> Server response received. Success: ${serverResponse.success}, Response: ${serverResponse.response}, Data: ${serverResponse.response}")
